...
if (document.body.contains(document.getElementById('countdownTP'))){
...
if (document.body.contains(document.getElementById('countdownJurnal'))){
...
//this is only for form praktikan submit
